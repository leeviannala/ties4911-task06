class WatsonAccountSettings:
    ...
    def __init__(self):
        ...
        self.__username = __lines[1].strip()
        self.__password = __lines[2].strip()
        self.__env_id = __lines[3].strip()
        self.__coll_id = __lines[4].strip()
        self.__conf_id = __lines[5].strip()
